...
void Registration::execute_icp_registration(double threshold, int max_iteration,
    ...
    // If mode=="svd" use get_svd_icp_transformation if mode=="lm" use
    // get_lm_icp_transformation. Remember to update transformation_ class
...
Registration::find_closest_point(
    double
        threshold) {  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
Eigen::Matrix4d Registration::get_svd_icp_transformation(
