...
class SGM {
   public:
    SGM(unsigned int disparity_range, unsigned int p1 = 3, unsigned int p2 = 40,
        unsigned int window_height = 3, unsigned window_width_ = 3);
   ...
   private:
    ...
    void compute_path_cost(int direction_y, int direction_x, int cur_y,
